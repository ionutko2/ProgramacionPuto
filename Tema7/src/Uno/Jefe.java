...
public class Jefe extends Empleado{
	...
	/**
	 * Pedir los datos del jefe (que son los datos del empleado añadiendole título y departamento
	 */
	void pedirDatos() {
		Scanner teclado = new Scanner(System.in);
		super.pedirDatos();
		System.out.println("Escriba que título tiene");
	...
	void imprimirDatos() {
		super.imprimirDatos();
		System.out.println(" Título: " + titulo + " Departamento: " + departamento);
	}
}
